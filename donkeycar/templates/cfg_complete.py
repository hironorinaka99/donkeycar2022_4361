...
MAX_EPOCHS = 50 #Nakagawa                #how many times to visit all records of your data
...
EARLY_STOP_PATIENCE = 2 #Nakagawa         #how many epochs to wait before no improvement
